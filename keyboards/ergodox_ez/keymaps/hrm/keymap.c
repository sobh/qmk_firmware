...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[SYM_L] = LAYOUT_ergodox_pretty(
		...
		_______,            TD(TD_ALT_TILDE),   KC_HASH,            TD(TD_CTL_LPRN),    TD(TD_GUI_RPRN),    KC_PERCENT,                                                             KC_AMPR,    TD(TD_GUI_COLN),    TD(TD_CTL_DOLLAR),  KC_ASTERISK,        KC_LEFT_ALT,        KC_DOUBLE_QUOTE,
