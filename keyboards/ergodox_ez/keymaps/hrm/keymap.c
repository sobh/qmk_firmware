...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE_L] = LAYOUT_ergodox_pretty(
        ...
        _______,            ALT_T(KC_A),        GUI_T(KC_S),        CTL_T(KC_D),        SFT_T(KC_F),        KC_G,                                                                   KC_H,       SFT_T(KC_J),        CTL_T(KC_K),    GUI_T(KC_L),            ALT_T(KC_SCLN),     KC_QUOTE,
    ...
    [PAD_L] = LAYOUT_ergodox_pretty(
        ...
        TO(BASE_L),         KC_LEFT_ALT,        KC_LEFT_GUI,        KC_LEFT_CTRL,       KC_LEFT_SHIFT,      XXXXXXX,                                                                KC_EQUAL,   KC_4,               KC_5,               KC_6,               KC_ASTR,            KC_ENTER,
